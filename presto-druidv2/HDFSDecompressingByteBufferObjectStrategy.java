...
{
    private static final Logger log = new Logger(HDFSDecompressingByteBufferObjectStrategy.class);
    ...
    public HDFSDecompressingByteBufferObjectStrategy(ByteOrder order,
    ...
    @Override @SuppressWarnings("unchecked") public Class<ResourceHolder<ByteBuffer>> getClazz()
    {
        return (Class) ResourceHolder.class;
    }

    @Override public ResourceHolder<ByteBuffer> fromByteBuffer(ByteBuffer buffer, int numBytes)
    {
        ...
        //log.info(new IOException(), decompressor + " decompress " + (endTime - startTime) + " ns.");
    ...
    @Override public int compare(ResourceHolder<ByteBuffer> o1, ResourceHolder<ByteBuffer> o2)
    {
        throw new UnsupportedOperationException();
    }

    @Override public byte[] toBytes(ResourceHolder<ByteBuffer> holder)
    {
        throw new UnsupportedOperationException();
    }
}
