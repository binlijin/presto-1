...
public class HDFSDoublesColumn
        implements NumericColumn
{
    /**
     * Factory method to create DoublesColumn.
     */
    public static HDFSDoublesColumn create(ColumnarDoubles column, ImmutableBitmap nullValueBitmap)
    {
        if (nullValueBitmap.isEmpty()) {
            return new HDFSDoublesColumn(column);
        }
        else {
    ...
    HDFSDoublesColumn(ColumnarDoubles columnarDoubles)
    {
