...
public class FloatColumnVectorReader
        implements ColumnReader
{
    ...
    public FloatColumnVectorReader(VectorOffset vectorOffset, BaseColumn baseColumn)
    {
    ...
    public Block readBlock(Type type, int batchSize, boolean filterBatch)
    {
        ...
        if (filterBatch) {
            ...
            for (int i = 0; i < batchSize; i++) {
                type.writeLong(builder, floatToRawIntBits(floatVector[i]));
            }
