...
public class TimestampColumnVectorReader
        implements ColumnReader
{
    ...
    public TimestampColumnVectorReader(VectorOffset vectorOffset, BaseColumn baseColumn)
    {
        ...
        this.vectorValueSelector = baseColumn.makeVectorValueSelector(vectorOffset);
    }
    ...
    public Block readBlock(Type type, int batchSize, boolean filterBatch)
    {
        ...
        if (filterBatch) {
            ...
            for (int i = 0; i < batchSize; i++) {
                type.writeLong(builder, longVector[i]);
            }
