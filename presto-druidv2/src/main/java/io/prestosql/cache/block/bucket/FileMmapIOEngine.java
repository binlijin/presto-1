        ...
        extends PersistentIOEngine
{
    ...
    public FileMmapIOEngine(String filePath, long capacity)
            throws IOException
    {
        super(filePath);
        this.path = filePath;
        ...
        ByteBufferAllocator allocator = new ByteBufferAllocator()
        {
            ...
            public ByteBuffer allocate(long size)
                    throws IOException
            {
                ByteBuffer buffer = fileChannel.map(FileChannel.MapMode.READ_WRITE,
    ...
    @Override
    public abstract Cacheable read(BucketEntry be)
            throws IOException;
     ...
     */
    @Override
    public void write(ByteBuffer srcBuffer, long offset)
            throws IOException
    {
    ...
    @Override
    public void write(ByteBuff srcBuffer, long offset)
            throws IOException
    {
