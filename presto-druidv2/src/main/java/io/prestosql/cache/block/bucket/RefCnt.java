 ...
 * reference count become 0, it'll call {@link ByteBuffAllocator.Recycler#free()} exactly once.
 */
public class RefCnt
        extends AbstractReferenceCounted
{
    private ByteBuffAllocator.Recycler recycler = ByteBuffAllocator.NONE;
