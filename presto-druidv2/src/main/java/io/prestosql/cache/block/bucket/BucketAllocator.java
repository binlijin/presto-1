...
import io.prestosql.cache.block.BlockCacheFactory;
...
public final class BucketAllocator
{
    ...
    final class BucketSizeInfo
    {
        ...
        private LinkedMap bucketList;
        private LinkedMap freeBuckets;
        private LinkedMap completelyFreeBuckets;
        private int sizeIndex;
    ...
    private static final int[] DEFAULT_BUCKET_SIZES = {4 * 1024 + 1024, 8 * 1024 + 1024,
            ...
            512 * 1024 + 1024, 1024 * 1024 + 1024, 2048 * 1024 + 1024};
