...
public final class ByteBufferUtils
{
    ...
    public static final int NEXT_BIT_MASK = 1 << 7;

    private ByteBufferUtils()
    {
    }

    abstract static class Comparer
    {
    ...
    static class ConverterHolder
    {
        static final String UNSAFE_CONVERTER_NAME =
                ConverterHolder.class.getName() + "$PureJavaConverter";
    ...
    /**
     * Similar to {@link WritableUtils#writeVLong(DataOutput, long)},
     ...
     * @throws IllegalArgumentException if there's not enough bytes left in the buffer after the given offset
     */
