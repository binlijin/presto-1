        ...
        implements HBaseReferenceCounted
{
     ...
     */
    public abstract int read(FileChannel channel, long offset)
            throws IOException;

    /**
     * Write this ByteBuff's data into target file
     */
    public abstract int write(FileChannel channel, long offset)
            throws IOException;
    ...
    {
        int read(ReadableByteChannel channel, ByteBuffer buf, long offset)
                throws IOException;
    }
