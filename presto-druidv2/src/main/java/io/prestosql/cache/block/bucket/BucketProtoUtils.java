...
final class BucketProtoUtils
{
            ...
            throws IOException
    {
        ...
        for (BucketCacheProtos.BackingMapEntry entry : backingMap.getEntryList()) {
            ...
            if (deserializerClass.equals(FileBlock.BlockDeserializer.class.getName())) {
                int actualIndex = FileBlock.BLOCK_DESERIALIZER.getDeserializerIdentifier();
