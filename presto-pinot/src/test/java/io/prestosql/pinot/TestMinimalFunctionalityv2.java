...
public class TestMinimalFunctionalityv2
        extends AbstractTestQueryFramework
{
            ...
            throws Exception
    {
        ...
        Map<String, String> pinotProperties = ImmutableMap.<String, String>builder()
                ...
                .put("pinot.max-rows-per-split-for-segment-queries", "8")
                .build();
...
//    }
    ...
    public void testIntegerType()
    {
        ...
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city = 'Los Angeles'");
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city = 'Los Angeles' and lucky_number > 6");
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city = 'Los Angeles' and lucky_number >= 6");
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city = 'Los Angeles' and lucky_number < 6");
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city = 'Los Angeles' and lucky_number <= 6");
        MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and (city = 'Los Angeles' or lucky_number <= 6)");

        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' or city = 'Los Angeles'");
        //MaterializedResult result = computeActual("SELECT lucky_number FROM " + TOPIC_AND_TABLE + " WHERE vendor = 'vendor1' and city in ('Los Angeles', 'New York')");
